...
CREATE TABLE IF NOT EXISTS "public"."registrations" (
    ...
    "paid_at" timestamp with time zone DEFAULT timezone('Asia/Seoul'::text, now()),
    "amount" integer,
    "order_id" "text"
);
...
ALTER TABLE ONLY "public"."registrations"
    ADD CONSTRAINT "registrations_order_id_key" UNIQUE ("order_id");
...
CREATE POLICY "Allow authenticated payment logs select" ON "public"."payment_logs" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "Allow public payment logs insert" ON "public"."payment_logs" FOR INSERT WITH CHECK (true);
