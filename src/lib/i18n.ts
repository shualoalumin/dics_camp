...
export const translations = {
  header: {
    en: {
      ...
      contact: 'Contact',
      banner: {
        registration: 'Registration opens June 2nd (Monday) - Limited spots available!',
  ...
  hero: {
    en: {
      ...
      subtitle: 'Experience the life-changing power of WOLBI Jeju, now launching for the first time in your city.',
  ...
  about: {
    en: {
      ...
      collaboration: {
        ...
        description: "DICS and WOLBI Jeju join forces to bring you an unparalleled English camp experience. This collaboration combines DICS's educational excellence with WOLBI's proven English immersion program, creating a transformative environment where faith meets language learning."
      }
    },
    ko: {
      title: '캠프 소개',
      subtitle: 'WOLBI Jeju와의 다년간의 협력과 비전 공유를 통해,\nDICS는 대구경산 지역 최초의 국제 크리스천 캠프를 개최하게 되었습니다.\n이 캠프는 우리지역 청소년의 신앙, 언어, 그리고 선교의 새로운 시작이 될 것입니다.',
      organizations: {
        dics: {
          name: 'DICS',
          role: '주최 & 주관'
      ...
      features: {
        duration: {
          title: '5일간의 변화',
          description: '크리스천 환경에서 진행되는 완벽한 영어 몰입 경험을 통해 신앙과 언어를 함께 배우고 성장하세요.'
        },
        location: {
          title: 'DICS 캠퍼스',
          description: '영적 성장과 국제적 학습을 위한 프로그램 환경과 완벽한 숙소를 제공합니다.'
        },
        partnership: {
          title: '월비제주 파트너십',
          description: '국제적으로 인정받은 WOLBI의 경험을 여러분의 지역사회에 처음으로 선보입니다.'
        },
        students: {
          title: '대상 학생',
          description: '2011년 이전 출생 학생(중2~고3)을 대상으로 하며, 신앙과 영어 실력 향상을 함께 추구합니다.'
        }
      },
      collaboration: {
        title: 'Special Collaboration',
        description: 'DICS의 국제적 교육 전문성과 WOLBI의 검증된 영어 몰입 프로그램이 만나 신앙과 언어 학습이 조화를 이루는 변화의 장을 만듭니다.'
      }
    }
  },
  special: {
    en: {
      ...
      subtitle: "This is the first time the internationally recognized WOLBI English camp has reached the Daegu-Gyeongsan region. It's more than just a camp — it's a movement of faith and global learning, and you're invited to be part of this exciting new chapter.",
      timeline: {
        wolbi: {
          title: 'WOLBI Jeju',
    ...
    ko: {
      title: 'A New Beginning — A Historic First',
      subtitle: '국제적으로 인정받은 WOLBI Camp가 처음으로 대구경산 지역에 찾아옵니다. 단순한 캠프를 넘어 신앙과 글로벌 학습의 움직임이 시작됩니다. 이 흥미진진한 새 장을 함께 열어갈 여러분을 초대합니다.',
      timeline: {
        wolbi: {
          title: 'WOLBI Jeju',
          subtitle: 'Years of Impact'
  ...
  highlights: {
    en: {
      ...
      subtitle: 'Experience a transformative program that combines English language immersion with spiritual growth in a supportive community environment.',
      features: {
        immersion: {
        ...
        leaders: {
          ...
          description: "Benefit from DICS+WOLBI's unmatched expertise in creating diverse, engaging activities that naturally enhance language learning through meaningful interactions."
        },
        dormitory: {
    ...
    ko: {
      title: '캠프 특징',
      subtitle: '영어 몰입 환경과 신앙 성장이 어우러진 특별한 프로그램으로, \n따뜻한 공동체 안에서 진정한 변화를 경험해 보세요.',
      features: {
        immersion: {
          title: '24시간 영어 몰입 환경',
          description: '원어민 멘토들과 함께 완전한 영어 환경에서 생활하며 자연스러운 대화와 매일의 연습을 통해 자신감을 키워보세요.'
        },
        worship: {
          title: '역동적인 예배',
          description: '현대적이고 생동감 있는 예배와 성경 공부, 삶을 변화시키는 메시지를 통해 깊은 영적 감동을 느껴보세요.'
        },
        leaders: {
          title: '전문 프로그램 리더',
          description: '의미 있는 상호작용과 다양한 활동을 통해 자연스럽게 영어 실력을 키워주는 DICS와 WOLBI의 독보적인 교육 전문성을 경험해보세요.'
        },
        dormitory: {
          title: '기숙사 생활',
          description: '다양한 배경을 가진 룸메이트들과의 생활, 저녁 활동, 그리고 의미 있는 대화를 통해 오래 지속될 소중한 우정을 쌓아보세요.'
        },
        counselors: {
          title: '24시간 전담 캠프카운슬러',
          description: '캠프 참가자들과 함께 생활하며 정서적 지지와 영적 멘토링을 제공하고, 안전하고 따뜻한 환경 속에서 개인적 성장을 돕는 전담 카운슬러와 함께하세요.'
        },
        perspective: {
          title: '글로벌 감각 확장',
          description: '다양한 국적의 멘토 및 친구들과의 만남을 통해 시야를 넓히고, 글로벌 시대를 준비하세요.'
        },
        exchange: {
          title: '글로벌 문화 교류',
          description: '국제적 스태프들과의 진정한 문화 교류 활동에 참여하며 자연스러운 영어 대화 능력과 세계적 이해력을 길러보세요.'
        },
        cuisine: {
          title: '국제적 식사 제공',
          description: '서양과 아시아 출신 전문 셰프가 준비하는 다양한 식사를 즐기며, 선교적 사명감을 지닌 스탭들이 최상의 식사 경험을 제공해드립니다.'
        },
        community: {
          title: '공동체 생활',
          description: '매일의 활동과 의미 있는 교제를 통해 신앙, 우정, 영어 학습이 자연스럽게 어우러지는 특별한 공동체 생활을 경험해보세요.'
        }
      }
    }
  },
  schedule: {
    en: {
      title: 'Camp Schedule',
      subtitle: 'Experience 5 days of transformative activities. Each day is carefully designed to maximize your growth in faith and English.',
    ...
    ko: {
      title: '캠프 일정',
      subtitle: '5일간 진행되는 특별한 변화를 경험하세요. 매일 매시간의 일정은 신앙과 영어 실력의 성장을 극대화할 수 있도록 세심하게 구성되어 있습니다.',
  ...
  gallery: {
    en: {
      title: 'Camp Gallery',
      subtitle: 'Experience the transformative moments from previous WOLBI programs. Your journey of faith and language awaits.',
      videos: {
    ...
    ko: {
      title: '캠프 갤러리',
      subtitle: '이전 월드바이블 프로그램의 변화의 순간들을 경험하세요. 여러분의 신앙과 언어의 여정이 기다립니다.',
      videos: {
        title: '캠프 하이라이트 영상',
  ...
  registration: {
    en: {
      title: 'Registration',
      subtitle: 'Secure your spot in this historic first camp. Space is limited to ensure quality experience and personal attention.',
      notice: {
        title: 'Important Notice',
        content: 'Registration is on a first-come, first-served basis. The registration may close early once capacity is reached. Early registration is highly recommended to secure your spot.'
      },
      info: {
        date: {
          title: 'Date',
      ...
      guidelines: {
        ...
        photo: {
          ...
          content: 'Photos and videos taken during the camp may be used for promotional purposes (website, social media, etc.)'
        }
      },
      form: {
        ...
        success: {
          ...
          message: "We've received your registration. Our team will contact you shortly with payment information and next steps.",
        ...
        sections: {
          ...
          additional: {
            ...
            address: {
              ...
              detailPlaceholder: 'Enter detailed address (building, unit number, etc.)'
            },
            church: {
    ...
    ko: {
      title: '등록',
      subtitle: '역사적인 첫 캠프에 참여할 기회를 놓치지 마세요. 높은 수준의 경험과 세심한 관리를 보장하기 위해 인원이 제한됩니다.',
      notice: {
        title: '중요 안내',
        content: '신청은 선착순으로 마감되며, 정원 초과 시 조기 마감될 수 있습니다. 자리 확보를 위해 빠른 신청을 권장합니다.'
      },
      info: {
        date: {
          title: '일정',
      ...
      guidelines: {
        ...
        photo: {
          title: '사진 및 영상 동의',
          content: '캠프 중 촬영된 사진과 영상은 홍보 목적(웹사이트, 소셜 미디어 등)으로 사용될 수 있습니다'
        }
      },
      form: {
        title: '캠프 등록 양식',
        success: {
          ...
          message: '등록이 접수되었습니다. 곧 담당자가 결제 정보와 다음 단계를 안내해 드리겠습니다.',
          button: '다른 학생 등록하기'
        },
        sections: {
          student: {
          ...
          additional: {
            ...
            address: {
              ...
              detailPlaceholder: '상세 주소를 입력해 주세요 (건물명, 동호수 등)'
            },
            church: {
              label: '교회명 (해당 시)',
              placeholder: ''
            ...
            specialNeeds: {
              label: '특별 요청사항',
              placeholder: '식이 제한, 의료 조건 또는 기타 특별한 요구사항이 있으시면 알려주세요.'
            }
          }
        },
        agreement: {
  ...
  testimonial: {
    ...
    ko: {
      ...
      items: [
        {
          quote: "제 인생을 완전히 바꿔놓았어요. 세계 각지의 친구들을 사귀고, 제 소명을 발견했으며, 하나님을 강력하게 만났습니다. 영어 몰입을 통해 자신감을 얻었지만, 영적 성장이 진정한 삶의 변화였죠.",
          author: "Sarah K.",
          role: "WOLBI Jeju Alumni"
        },
        {
          quote: "영어가 서툴고 수줍음 많은 학생으로 캠프에 왔는데, 이렇게 많이 성장할 줄 몰랐어요. 카운슬러들이 만들어준 따뜻한 환경 덕분에 며칠 만에 자연스럽게 영어로 대화하고 있는 제 모습을 발견했죠!",
          author: "Min-ho J.",
          role: "WOLBI Jeju Alumni"
        },
        {
          quote: "딸이 캠프에서 돌아온 후 영어 실력뿐만 아니라 목적의식과 자신감도 함께 성장했어요. 그들이 제공한 영적 기초는 딸이 강한 가치관과 명확한 방향성을 가지고 고등학교 생활을 해나가는 데 큰 도움이 되고 있습니다.",
          author: "Mrs. Park",
          role: "Parent of WOLBI Student"
        },
        {
          quote: "월비의 신앙과 영어 학습의 조화는 놀라운 분위기를 만들어냈어요. 언어 실력이 향상됐을 뿐만 아니라 하나님과의 관계도 더욱 깊어졌죠. 정말 인생을 바꾸는 경험이었습니다.",
          author: "Ji-eun L.",
          role: "WOLBI Jeju Alumni"
        },
        {
          quote: "카운슬러로서, 불과 며칠 만에 수많은 학생들이 변화하는 모습을 목격했습니다. 영적 성장과 언어 몰입이 독특하게 어우러진 이 프로그램은 지속적인 영향력을 만들어냅니다.",
          author: "David M.",
          role: "Former WOLBI Counselor"
        }
      ]
  ...
  faq: {
    ...
    ko: {
      title: '자주 묻는 질문',
      subtitle: 'DICS International Camp에 대한 일반적인 질문들에 대한 답변을 찾아보세요.',
      items: [
        {
          question: "이 캠프가 다른 영어 캠프와 비교해서 특별한 점은 무엇인가요?",
          answer: "이번 캠프는 제주 월드바이블 영어 캠프가 대구경산 지역으로 처음 확장되는 역사적인 순간입니다. 단순한 언어 학습을 넘어, 원어민 강사진이 이끄는 완벽한 영어 몰입 환경에서 신앙 기반 교육, 인성 개발, 영적 성장이 통합된 프로그램을 제공합니다. 학생들은 언어 실력과 삶의 관점에 영향을 미치는 변화의 공동체 생활을 경험하게 됩니다."
        },
        {
          question: "캠프 참가를 위해 어느 정도의 영어 실력이 필요한가요?",
          answer: "모든 영어 수준의 학생들을 환영합니다! 우리 프로그램은 다양한 숙련도의 학생들을 수용할 수 있도록 설계되었습니다. 몰입 환경은 자연스럽게 유창성 향상을 돕고, 멘토들은 개인의 필요에 맞는 적절한 지원을 제공합니다. 가장 중요한 요구사항은 영어로 말하려는 의지와 적극적인 참여입니다."
        },
        {
          question: "일과는 어떻게 진행되나요?",
          answer: "하루 일과는 아침 묵상, 영어 수업, 성경 기반 토론, 레크리에이션 활동, 예배가 포함된 저녁 프로그램, 소그룹 나눔으로 구성됩니다. 모든 활동은 영어로 진행되어 하루 종일 다양한 상황에서 지속적인 언어 연습 기회를 제공합니다."
        },
        {
          question: "학생들은 무엇을 준비해야 하나요?",
          answer: "개인용품(세면도구, 5일치 의류), 성경(가능하면 영어 버전), 노트, 필기구, 운동복, 단정한 수영복, 필요한 약품, 그리고 긍정적인 태도가 필요합니다! 자세한 준비물 목록은 등록 후 발송됩니다."
        },
        {
          question: "캠프 이후에도 후속 활동이 있나요?",
          answer: "네! 캠프 동안 쌓은 우정과 동력을 유지하기 위해 동창회 행사, 온라인 커뮤니티 그룹, 정기 모임을 조직합니다. 학생들은 DICS와 월드바이블 커뮤니티의 일원이 되어 지속적인 성장 기회를 갖게 됩니다."
        }
      ]
    }
  },
  footerCta: {
    en: {
      ...
      subtitle: "English, faith, and transformation await. Be part of history as we launch the first DICS International English Camp.",
      cta: {
    ...
    ko: {
      ...
      subtitle: "영어, 신앙, 그리고 변화가 기다립니다. DICS 국제 영어 캠프의 첫 역사를 함께 만들어가세요.",
      cta: {
        primary: "캠프 참가하기",
